...
class HealthRecordsManager {
    ...
    bindEvents() {
        ...
        document.getElementById('add-record-modal').addEventListener('click', (e)=>{
            if (e.target.id === 'add-record-modal') this.closeModal();
        });
    }
    ...
    renderRecords() {
        ...
        const filteredRecords = this.currentFilter === 'all' ? this.records : this.records.filter((record)=>record.type === this.currentFilter);
...
//# sourceMappingURL=health-records.56acd662.js.map
